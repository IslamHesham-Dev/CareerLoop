...
class _SignOutButton extends StatelessWidget {
  ...
  Future<void> _signOut(BuildContext context) async {
    ...
    // Clear chat locally. Waiting for its remote reset used to block logout
    // for minutes when the backend was slow or unavailable.
    advisor.clearLocal();
    academic.clearLocal();
    cms.clearLocal();
    notion.clearLocal();
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  connected
                      ? '${name ?? 'Professional profile'} · Connected'
